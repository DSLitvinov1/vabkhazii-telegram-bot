...
cases={
 ...
 'Ребёнок путает буквы и делает ошибки на письме':'письмо и дисграфические ошибки',
 'Ребёнок говорит невнятно':'разборчивость речи',
 'У ребёнка очень мало слов':'словарный запас и развитие речи',
 'Переставляет слоги в длинных словах':'слоговая структура речи',
